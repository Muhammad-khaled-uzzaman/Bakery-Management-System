...
import bakery_management_system.Product_class;
...
public class ProductGui extends javax.swing.JFrame {
    ...
    Product_class pdao = new Product_class();
    ...
    private void btnSaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSaveActionPerformed
        ...
        if(txtName.getText().equals("")){
            JOptionPane.showMessageDialog(txtId, "Enter Product Name");
        }
        else if(txtUniteprice.getText().equals("")){
            JOptionPane.showMessageDialog(txtId, "Enter Product unit price");
        }
        else{
        Product p =new Product();
        p.setProduct_id(Integer.parseInt(txtId.getText().trim()));
