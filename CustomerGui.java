...
import bakery_management_system.Customer_class;
...
public class CustomerGui extends javax.swing.JFrame {
    Customer_class dao = new Customer_class();
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addComponent(jPanel4, javax.swing.GroupLayout.PREFERRED_SIZE, 66, Short.MAX_VALUE))
                .addGap(43, 43, 43))
        );
    ...
    private void btnSaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSaveActionPerformed
       ...
       d.setCustomer_id(Integer.parseInt(txtId.getText().trim()));
       ...
       d.setDue_balance(Float.parseFloat(txtDue.getText().trim()));
        ...
        try {
            dao.save(d);
            JOptionPane.showMessageDialog(null, "Customer  value Saved");
    ...
    private void btnDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDeleteActionPerformed
        ...
        try {
            dao.delete(d);
            JOptionPane.showMessageDialog(null,"Customer  value Deleted successsfull!");
            txtId.setText("");
            txtName.setText("");
            txtPhone.setText("");
            txtAddress.setText("");
    ...
    private void btnDisplayActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDisplayActionPerformed
        try {
            rsm.setResultSet(du.select("SELECT * FROM CUSTOMER "));
        } catch (SQLException ex) {
            Logger.getLogger(CustomerGui.class.getName()).log(Level.SEVERE, null, ex);
        }
